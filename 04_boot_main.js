...
const VALID_EFFECT_TYPES     = new Set([
  ...
  // Phase 0 triggers — bare effect blocks attached to non-resolve hooks
...
const VALID_KEYWORDS = new Set([
  ...
  'lifesteal',  // ATK damage dealt also restores Morale
  'taunt',      // opposite monster ATK is absorbed by this hero (hero forfeits its action)
  'charge',     // on recruit, goes to top of deck instead of discard
  'echo',       // after resolving, returns to hand instead of discard
]);
...
// ─────────────────────────────────────────────────────────────
// TREASURE DEFINITION VALIDATOR (Phase 5)
// ─────────────────────────────────────────────────────────────
